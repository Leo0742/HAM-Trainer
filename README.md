...
- 24 отдельные экзаменационные схемы без подсвеченного ответа, 9 учебных схем, поиск, фильтры, закладки и отметка трудных вопросов;
...
2. `ContentOverrides/questions-*.json` хранит явные учебные слои для всех 405 вопросов и переживает повторный импорт;
3. `Tools/build_content.py` собирает curated-слой, точечные исправления и глоссарий; fallback не считается curated;
...
Текущий аудит: 405/405 explicit curated начальных объяснений, 405/405 рассуждений, 405/405 полных разборов неправильных вариантов, 400 exact + 5 manual и 0 fuzzy сопоставлений, 142 термина, 24 исходные и 9 учебных схем. Подробности: [`docs/content-audit.md`](docs/content-audit.md), [`docs/answer-match-audit.md`](docs/answer-match-audit.md) и [`docs/source-provenance.md`](docs/source-provenance.md).
...
ContentOverrides/       explicit curated слои и точечные source-исправления

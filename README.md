...
- 176 встроенных терминов с отдельными объяснениями «с нуля», персональный глоссарий, заметки и тематический повтор;
...
Текущий аудит: 405/405 авторских записей, 0 fallback, 0 нерешённых option/glossary-сопоставлений, 400 exact + 5 manual и 0 fuzzy ответов, 176 терминов, 26 экзаменационных и 9 учебных схем. Подробности: [`docs/content-audit.md`](docs/content-audit.md), [`docs/answer-match-audit.md`](docs/answer-match-audit.md) и [`docs/source-provenance.md`](docs/source-provenance.md).
